...
<head>
  ...
  <style>
    ...
    .HeadingIntro h1,.HeadingIntro h3{
        color:black;

    }
    .HeadingIntro h1:hover,.HeadingIntro h3:hover,.githubProfileViewBatch img:hover,.learning_ReachMe p:hover,.Connect_With_Me h3:hover,.GitHubReadme p:hover,.Languages_And_Tools h3:hover{
         
        transition: 250ms transform ease-in;
        transform: rotate(3deg);
    }
    .Connect_With_Me a img:hover,.Languages_And_Tools img:hover{
        background-color: white;
       border-radius: 100px;
        transition: 500ms transform ease-in-out;
        transform:rotate(1800deg);
    }
    .Languages_And_Tools a img{
        border:1px solid orange;
        border-radius: 100px;
    }
    .githubProfileViewBatch{
        display: flex;
        
    }
    .githubProfileViewBatch,.githubProfileViewBatch img{
       padding: 33px;
    }
    ...
    .Connect_With_Me p,.Connect_With_Me a,h3{
        align-items: center;
        margin:33px;
        padding:33px;
    }
    ...
    .Languages_And_Tools p,.Languages_And_Tools img,.Connect_With_Me img{
        margin: auto;
        padding: 33px;
    }
    .GitHubReadme{
